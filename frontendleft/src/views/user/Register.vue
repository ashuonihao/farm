          ...
          <el-row type="flex" justify="center" align="middle" style="height: 100%">
            <el-form ref="loginRef" :model="loginForm" :rules="loginRules" label-width="100px" style="width: 80%">
              ...
              <el-form-item label="密码" prop="password">
                <el-input v-model="loginForm.password" type="text"  prefix-icon="el-icon-lock" placeholder="请输入密码"></el-input>
              </el-form-item>
              <el-form-item>
              ...
              <el-form-item style="text-align: center">
                <el-button type="primary" round @click="loginBtn" style="width: 100%">注册</el-button>
              </el-form-item>
            </el-form>
          </el-row>
        </el-col>
